...
Blue: Jarbas Mattos: peruaves.org
...
-   We used RStudio for data analysis (RStudio Team, 2019). In addition, we used R packages tidyverse (Wickham *et al*., 2019), ggplot2 (Wickham H, 2016) and ggrepel (Slowikowski *et al.*, 2021).
